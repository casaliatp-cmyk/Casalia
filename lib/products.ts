...
export const products: Product[] = [
  ...
  },
  {
    ...
    reviewCount: 96,
    images: [
      "public/gorras/Gorra01.png",
      "public/gorras/Gorra01.png'",
    ],
    shortDescription: "Algodón orgánico en tono oliva con bordado tono a tono.",
    description:
      "Una gorra de seis paneles en algodón orgánico, con bordado tono a tono del logotipo CASALIA y cierre trasero ajustable de metal.",
    features: [
      "100% algodón orgánico",
      "Bordado tono a tono",
      "Cierre trasero ajustable de metal",
      "Visera pre-curvada",
    ],
    reviews: sampleReviews.slice(0, 2),
  },
  {
    id: "p6",
    slug: "gorra-linen-classic",
    name: "Gorra Linen Classic",
    category: "gorras",
    price: 79000,
    rating: 4.4,
    reviewCount: 41,
    ...
    shortDescription: "Un básico versátil en tono lino con visera curva.",
    description:
      "Ligera, transpirable y fácil de combinar. La gorra Linen Classic es el complemento silencioso para looks de diario.",
    features: [
