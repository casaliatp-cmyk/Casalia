...
export const products: Product[] = [
  ...
  },
  {
    ...
    bestSeller: true,
    images: [
      "/tecnologia/Reloj-Banda-Negro.png",
    "/tecnologia/Reloj-Banda-blanco.png",
    "/tecnologia/Reloj-Banda-gris.png",
    ],
    shortDescription: "Pulsera ligera y versátil para acompañarte todos los días.",
    description:
      "Diseñada para complementar tu rutina diaria y un diseño cómodo.",
    features: [
